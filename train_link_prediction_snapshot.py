...
from evaluate_models_utils import evaluate_model_link_prediction, evaluate_snapshot_model_link_prediction
from utils.metrics import get_link_prediction_metrics
from utils.DataLoader import get_idx_data_loader, get_snapshot_idx_data_loader, get_link_prediction_data
...
if __name__ == "__main__":
    ...
    val_idx_data_loader = get_snapshot_idx_data_loader(interact_times=val_data.node_interact_times)
    test_idx_data_loader = get_snapshot_idx_data_loader(interact_times=test_data.node_interact_times)
    ...
    for run in range(args.num_runs):
        ...
        for epoch in range(args.num_epochs):
            ...
            if (epoch + 1) % args.test_interval_epochs == 0:
                test_losses, test_metrics = evaluate_snapshot_model_link_prediction(model_name=args.model_name,
                                                                           model=model,
                                                                           neighbor_sampler=full_neighbor_sampler,
